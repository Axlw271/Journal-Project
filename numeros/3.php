...
<header>
	...
	<div class="logo">
		<p>Actividad 3: Números del 1 al 20 en Lengua de Señas Mexicana (LSM)</p><br>
	</div>  
</header>

<body>
	<div class="home-box custom-box">
		<h5>1. Observa la seña en la imagen.</h5><h5>2. Escribe en el cuadro de texto de qué seña se trata.</h5>
	</div>
...
<script>
    ...
    setTimeout(() => {
        overlay.style.display = 'none';
            ...
            function registro(){
            const data = new URLSearchParams("act_id=num3 & resultado=10");
            fetch('../resultado.php', {
            method: 'POST',
            body: data
            })
