...
<body>	
    ...
    <h3>Comida en Lengua de Señas Mexicana (LSM)</h3>
        ...
        <div class="card-wrapper swiper-wrapper">
            <div class="card swiper-slide">
                ...
                <div class="card-content">
					...
					<a href="comida/1.php"><button class="button">Empezar</button></a>
                </div>
            </div>
            <div class="card swiper-slide">
                <div class="image-content" style="background-color: #3498db;">
                ...
                <div class="card-content">
					...
					<a href="comida/2.php"><button class="button">Empezar</button></a>
                </div>
            </div>
            <div class="card swiper-slide">
                <div class="image-content" style="background-color: #3498db;">
                ...
                <div class="card-content">
					...
					<a href="comida/3.php"><button class="button">Empezar</button></a>
                </div>
                ...
                <div class="card-content">
					...
					<a href="comida/4.php"><button class="button">Empezar</button></a>
                </div>
            </div><div class="card swiper-slide">
                <div class="image-content" style="background-color: #3498db;">
                ...
                <div class="card-content">
					...
					<a href="comida/5.php"><button class="button">Empezar</button></a>
                </div>
            </div><div class="card swiper-slide">
                <div class="image-content" style="background-color: #3498db;">
                ...
                <div class="card-content">
					...
					<a href="comida/6.php"><button class="button">Empezar</button></a>
                </div>
            </div>
