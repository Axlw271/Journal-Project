...
<body>	
    ...
    <h3>Saludos en Lengua de Señas Mexicana (LSM)</h3>
        ...
        <div class="card-wrapper swiper-wrapper">
            <div class="card swiper-slide">
                ...
                <div class="card-content">
					...
					<a href="saludos/1.php"><button class="button">Empezar</button></a>
                </div>
            </div>
            <div class="card swiper-slide">
                <div class="image-content" style="background-color: #3498db;">
                ...
                <div class="card-content">
					...
					<a href="saludos/2.php"><button class="button">Empezar</button></a>
                </div>
            </div>
            <div class="card swiper-slide">
                <div class="image-content" style="background-color: #3498db;">
                ...
                <div class="card-content">
					...
					<a href="saludos/3.php"><button class="button">Empezar</button></a>
                </div>
                ...
                <div class="card-content">
					...
					<a href="saludos/4.php"><button class="button">Empezar</button></a>
                </div>
            </div><div class="card swiper-slide">
                <div class="image-content" style="background-color: #3498db;">
                ...
                <div class="card-content">
					...
					<a href="saludos/5.php"><button class="button">Empezar</button></a>
                </div>
            </div><div class="card swiper-slide">
                <div class="image-content" style="background-color: #3498db;">
                ...
                <div class="card-content">
					...
					<a href="saludos/6.php"><button class="button">Empezar</button></a>
                </div>
            </div>
