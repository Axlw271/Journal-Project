...
<header>
	...
	<div class="logo">
		<p>Actividad 2: Estados de la República Mexicana en Lengua de Señas Mexicana (LSM)</p><br>
	</div>  
</header>
...
function registro(){
            const data = new URLSearchParams("act_id=via2 & resultado=10");
            fetch('../resultado.php', {
            method: 'POST',
            body: data
            })
