...
<body>
    <header>
        ...
        <div class="logo">
            <p>Actividad 2: Abecedario en Lengua de Señas Mexicana (LSM)</p><br>
        </div>
    </header>
    ...
    <script>
        ...
        function test(n) {
            ...
            // construir texto con las letras
    ...
    "<td class='w3-hover-blue' onclick='good()'><video autoplay loop muted class='video' onmouseover='highlightImage(this)' onmouseout='unhighlightImage(this)'><source src= " + words[n + 1][0] + ".mp4 type='video/mp4'>Tu navegador no soporta el elemento de video.</video></td>"
        ...
        function registro(){
            const data = new URLSearchParams("act_id=abc2 & resultado=10");
            fetch('../resultado.php', {
            method: 'POST',
            body: data
            })
