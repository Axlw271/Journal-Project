...
const keysArray = Object.keys(images);
    ...
    function verificarPareja() {
      ...
      var primerosTresCaracteresCarta1 = carta1.dataset.valor.substring(53, 56);
    
      if(carta2.dataset.valor.length<20)
      var primerosTresCaracteresCarta2 = carta2.dataset.valor.substring(0, 3);
      else
      var primerosTresCaracteresCarta2 = carta2.dataset.valor.substring(53, 56);
    ...
    function registro(){
            const data = new URLSearchParams("act_id=sal4 & resultado=10");
            fetch('../resultado.php', {
            method: 'POST',
            body: data
            })
